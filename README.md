...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("dev.brewkits:grant-core:1.4.0")
            implementation("dev.brewkits:grant-compose:1.4.0")    // Optional: Compose dialogs
            implementation("dev.brewkits:grant-core-koin:1.4.0")  // Optional: Koin DI support
        }
    }
}
```
...
> [!NOTE]
> **Koin users**: The Koin integration was moved to `grant-core-koin` in v1.4.0. Add the new artifact alongside `grant-core` and replace `GrantPlatformModule` imports. See the [Migration Guide](docs/MIGRATION_GUIDE.md).
...
| [Migration Guide](docs/MIGRATION_GUIDE.md) | Upgrading from v1.2.x to v1.4.0 |
