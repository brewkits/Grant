package dev.brewkits.grant.location.stress
...
/**
 * Stress tests for concurrent always-location operations: concurrent requests
 * to one handler, rapid request/dismiss cycles, and rapid status flapping.
 */
@OptIn(ExperimentalCoroutinesApi::class)
class LocationAlwaysStressTest {
